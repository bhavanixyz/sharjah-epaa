...
export default function ServiceProviderContacts() {
  ...
  const contacts = [
    ...
    { id: 'sp-2', provider: 'Horiba Instruments Middle East', contactPerson: 'Eng. Ahmed Al-Standard', role: 'Regional Maintenance Manager', email: 'ahmed.standard@horiba.ae', phone: '+971 4 883 7070', region: 'UAE & GCC Region', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-3', provider: 'Thermo Fisher Scientific', contactPerson: 'David Miller', role: 'Gas Analyzer Specialist', email: 'david.miller@thermofisher.com', phone: '+971 4 457 1100', region: 'Global Field Support', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-4', provider: 'Emirates Calibration Laboratories', contactPerson: 'Mariam Al-Kabi', role: 'ISO 17025 Lead Auditor', email: 'mariam@emicalib.ae', phone: '+971 6 534 2200', region: 'Sharjah Industrial', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-5', provider: 'Vaisala Gulf Meteorological FZE', contactPerson: 'Hassan Al-Zahabi', role: 'Microclimate Technical Lead', email: 'h.alzahabi@vaisala.com', phone: '+971 4 881 9920', region: 'GCC Regional Office', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-6', provider: 'YSI Xylem Water Solutions', contactPerson: 'Dr. Sarah Jenkins', role: 'Marine Sonde Calibration Lead', email: 's.jenkins@xylem.com', phone: '+971 4 347 5588', region: 'Middle East & North Africa', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-7', provider: 'Campbell Scientific Middle East', contactPerson: 'Omar Al-Sabah', role: 'Telemetry & Data Logger Engineer', email: 'o.alsabah@campbellsci.ae', phone: '+971 6 557 4100', region: 'Sharjah Freezone', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-8', provider: 'Endress+Hauser Water Analytics', contactPerson: 'Kambiz Rostami', role: 'Flow Sensor Specialist', email: 'kambiz.rostami@endress.com', phone: '+971 4 810 5000', region: 'UAE Support Hub', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-9', provider: 'Aeroqual Air Monitoring Systems', contactPerson: 'Rachel Adams', role: 'Ambient AQ Sensor Auditor', email: 'r.adams@aeroqual.com', phone: '+971 4 329 1100', region: 'Middle East Division', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-10', provider: 'Tisch Environmental Inc.', contactPerson: 'Michael O\'Connor', role: 'High Volume Air Sampler Lead', email: 'moconnor@tisch-env.com', phone: '+1 513 467 9000', region: 'Global Technical Support', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-11', provider: 'OTT HydroMet GCC', contactPerson: 'Khalifa Al-Hajri', role: 'Hydrological Station Specialist', email: 'k.alhajri@otthydromet.com', phone: '+971 4 338 9090', region: 'GCC & Oman Territory', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' },
    { id: 'sp-12', provider: 'Hach Water Analytics Middle East', contactPerson: 'Fatima Al-Rumaithi', role: 'Water Quality Chemist', email: 'falrumaithi@hach.com', phone: '+971 4 887 6677', region: 'Sharjah & Northern Emirates', status: 'Active Vendor', date: '2026-08-25', lastAuditDate: '2026-08-25' }
  ];
